        ...
        <div class="card-custom p-4 mb-4">
            <div
                ...
                <div class="text-start">
                    <h3 class="fw-extrabold text-dark mb-1">Companies</h3>
                ...
                <button onclick="openCompanyForm(null)"
                    ...
                    <i class="bi bi-building-plus"></i> Add Company
                </button>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <form id="{{ base64_encode($item->id) }}"
                                        action="{{ route('admin.companies.destroy', $item->id) }}" method="POST"
                                        class="delete-form">
                                        @csrf
                                        @method('DELETE')
                                    </form>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 12px; overflow: hidden;">
                ...
                <div class="modal-body p-4 text-start" id="adminConfigModalBody">
                    <form action="{{ route('admin.companies.store') }}" method="post" id="modal-form">
                        @csrf
                        ...
                        <div class="mb-3 text-start">
                            ...
                            <div class="input-company">
                                <span class="input-company-text bg-white text-muted border-end-0"><i
                                        class="bi bi-organization"></i></span>
                                <input id="form-company-name" type="text" name="name" value="{{ old('name') }}"
...
@section('script')
    <script>
        ...
        function openCompanyForm(editId) {
            ...
            const name = document.getElementById('form-company-name');
            const methodInput = document.getElementById('formMethod');
            if (editId) {
                console.log(companyList)
                companyObj = companyList.find(c => c.id === editId);
                console.log(companyObj)
                name.value = companyObj.name
                label.innerText = "Modify Company Details";
                form.action = `/admin/companies/${companyObj.id}`;
                form.method = "POST"; // stays POST (HTML limitation)
                methodInput.value = "PUT"; // Laravel spoof
            } else {
                label.innerText = "Add Company";
            }
