...
@section('content')
    ...
    <div class="survey-card">
        <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
            ...
            <div class="dropdown">
                <button class="btn btn-spread-submit px-4 dropdown-toggle" style="background-color: #5c6bc0;" type="button"
        ...
        <div class="table-container">
            <div class="table-responsive">
                <table id="scribesTable" class="table table-spread align-middle mb-0">
                    <thead>
                        <tr>
                            <th>Scribe</th>
                            <th>Answered</th>
        ...
        <div class="text-center mt-4 pt-3 border-top">
            <a class="btn btn-spread-secondary" href="{{ route('forms.view-code', base64_encode($quiz->quiz_code)) }}">
                <i class="bi bi-plus-circle-fill me-1"></i> Start Another Survey
            </a>
        </div>
    </div>

    {{--  <div class="my-container pt-5">
        <a href="{{ route('forms.view') }}" class="btn btn-outline-primary btn-sm w-100 mb-5">BACK TO WORKSHOP</a>
        <h1 class="text-center"><b>{{ $quiz->title }}</b></h1>
        <small class="text-center">{{ $quiz->description }}</small>
        <div class="card mt-3 mb-3">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <label for="" class="text-primary fw-bolder">Scribes List</label>
                    <div class="">
            ...
            <div class="card-body">
                <div class="table-responsive table-for-scribe">
                    <table class="dataTable table ">
                        <thead>
                            <tr>
                                <th width="100">{{ __('Scribe') }}</th>
                                <th>{{ __('Answered') }}</th>
                                <th>{{ __('Item') }}</th>
                                <th>{{ __('Workshop') }}</th>
                                <th>{{ __('Company') }}</th>
